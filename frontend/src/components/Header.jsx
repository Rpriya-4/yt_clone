...
// // // // //             placeholder="Search"
// // // // //             className="w-full border rounded-full px-4 py-1 pl-10 focus:outline-none focus:ring-1 focus:ring-black"
// // // // //           />
...
// // // // //             {/* Dropdown */}
// // // // //             {open && (
// // // // //               <div className="absolute right-0 mt-2 w-64 bg-white shadow-xl rounded-lg border border-gray-200 overflow-hidden z-50">
// // // // //                 {/* Profile Section */}
...
// //       {/* Left: Empty (since sidebar has logo) */}
...
// //       {mobileSearch && (
// //         <div className="absolute top-full left-0 w-full bg-white shadow px-3 py-2 sm:hidden">
// //           <input
// //             type="text"
// //             value={query}
// //             onChange={(e) => setQuery(e.target.value)}
